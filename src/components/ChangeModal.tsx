            ...
            <div className="w-full h-full flex flex-col justify-between md:w-[50%] md:h-max bg-white border rounded-xl overflow-y-auto">
                ...
                <header className={headerClass}>
                    <div className={headerWrapperClass}>
                        <div>
                            <p className="tracking-widest uppercase text-[10px] md:text-[11px] text-[#1E40AF] font-semibold">{t('changeModal.edit')}</p>
                    ...
                    <div className={twMerge(borderClass, "bg-white flex flex-col gap-3")}>
                        ...
                        <label className={twMerge('flex justify-start items-center flex-wrap cursor-pointer')} htmlFor="removed-switch" >
                            ...
                            <div className={`relative border w-[49px] h-[23px] rounded-xl border-[#EAE9E2] bg-[#EAE9E2] 
                               peer-checked:bg-[#1E40AF] peer-checked:border-[#1E40AF] transition-colors duration-200
                            ...
                            <span className="ml-5 text-[#9E9E9E] tracking-wide font-semibold ">{t('changeModal.switchToRemoved')}</span>
